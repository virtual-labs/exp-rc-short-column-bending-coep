...
function loadCalculate() {
	...
	labels1 = '<div class="col-sm-12" id="forceEntered" >'
		+ '<div class="col-sm-5">'
		+ '<label  id="enterLoad"  class="" style="font-size:16px;margin:15px 10px ;">Calculate Factoried Moment M<sub>ux</sub> :  </label>'
		+ '</div>'
		...
		+ '<div class="col-sm-12" id="forceEntered" >'
		+ '<div class="col-sm-5">'
		+ '<label  id="enterLoad"  class="" style="font-size:16px;margin:15px 10px ;">Calculate b :  </label>'
		+ '</div>'
		+ '<div class="col-sm-3" id="valueStep1">'
		...
		if (pu_user == "") {
			...
			if (id <= 3) {
				if (pu_user >= pu_corr) {
					...
					$(".modal-header").html("Correct Message");
				...
				$("#btnModal").removeClass("btn-success").addClass("btn-danger");
				$("#MsgModal").html("Formula : M<sub>ux</sub>  = 1.5 X P<sub>u</sub>");
				...
				if (pu_user >= pu_corr) {
					...
					$(".modal-header").html("Suggestion Message");
					$(".modal-header").css("background", "blue");
					$("#btnModal").removeClass("btn-success").addClass("btn-danger");
	...
	$("#submit_load2").click(function() {
		...
		if (lx_user == "") {
			...
			$("#btnModal").removeClass("btn-success").addClass("btn-danger");
			$("#MsgModal").html("Enter Approriate value");
